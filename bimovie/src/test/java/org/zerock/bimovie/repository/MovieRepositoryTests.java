...
public class MovieRepositoryTests {
    ...
    public void testAddPoster() {
        ...
        Movie movie = movieRepository.getOne(3L);   //데이터베이스에 존재하는 영화 번호
    ...
    public void testRemovePoster() {
        ...
        Movie movie = movieRepository.getReferenceById(3L);
    ...
    public void testPaging4All() {
        ...
        Page<Object[]> result = movieRepository.findAll4(pageable);
